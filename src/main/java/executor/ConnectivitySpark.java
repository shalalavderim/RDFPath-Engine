...
public class ConnectivitySpark {
	...
	public static String foaf(String Person1, String Person2)
	{
		...
		String Query = "WITH st1 AS ( "+st1+" ), "
				+ "st2 as ( "+st2+" )"
						+ "SELECT l.c1 as c1, r.c5 as c2 FROM st1 l, st2 r "
						+ "WHERE l.c5 = r.c1 ";
	...
	public static String foaf3(String Person1, String Person2)
	{
		...
		String Query = "WITH st1 AS ( "+st1+" ), "
				...
				+ "st3 as ( "+st3+" ), "
				+ "st4 as ( "+st4+" ) "
						+ "SELECT l.c1 as c1, r.c5 as c2 FROM st4 l, st2 r "
						+ "WHERE l.c9 = r.c1 ";
	...
	public static String foaf4(String Person1, String Person2)
	{
		...
		String Query = "WITH st1 AS ( "+st1+" ), "
				...
				+ "st5 as ( "+st5+" ), "
				+ "st6 as ( "+st6+" ) "
						+ "SELECT l.c1 as c1, r.c9 as c2 FROM st4 l, st6 r "
						+ "WHERE l.c9 = r.c1 ";
